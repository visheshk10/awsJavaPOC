...
public class HelloWorldHandlerTest {
    ...
    private static final String EXPECTED_RESPONSE_VALUE = "Hello Vishesh! This made me Happy!!";
    ...
    void testHandleRequest() {
        ...
        assertEquals(EXPECTED_RESPONSE_VALUE, jsonObjectFromResponse.get("Hey"));
